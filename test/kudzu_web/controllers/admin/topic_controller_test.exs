defmodule KudzuWeb.Admin.TopicControllerTest do
  use KudzuWeb.ConnCase

  alias Kudzu.Topics

  @create_attrs %{description: "some description", matches: %{}, preferred_tag_id: 42, title: "some title"}
