defmodule KudzuWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug KudzuWeb.EnsureRolePlug, [:user, :admin]

      plug KudzuWeb.EnsureRolePlug, :admin

      plug KudzuWeb.EnsureRolePlug, ~w(user admin)a
  """
  ...
  defp maybe_halt(_any, conn) do
    conn
    |> Controller.put_flash(:error, "Unauthorized Access. Don't be this way.")
